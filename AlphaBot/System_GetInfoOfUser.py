...
#Получить планету
def getPlanets(user_id, file = 'общий'):
    lineInFile = getLineInFile(user_id, file)
    planeti = ''
    for i in lineInFile:
        if(i[0] != 'П'):
...
#получить добычу
def getExtractionFull(user_id, file = 'общий'):
    lineInFile = getLineInFile(user_id, file)
    extr = ''
    check = 0
    for i in lineInFile:
...
#получить добычу без нулей
def getExtractionReal(user_id, file = 'общий'):
    lineInFile = getLineInFile(user_id, file)
    extr = ''
    check = 0
    for i in lineInFile:
...
#получить запрашиваемую добычу
def getExtractionChRes(user_id, toFind, file = 'общий'):
    lineInFile = getLineInFile(user_id, file)
    res = ''
    check = 0
    for i in lineInFile:
...
#Получить кол-во добычи запрашиваемоего ресурса
def getExtractionChResBal(user_id, toFind, file = 'общий'):
    lineInFile = getLineInFile(user_id, file)
    res = ''
    check = 0
    for i in lineInFile:
